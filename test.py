...
# award_test_name = "best animated"
# test_list={
#     award_test_name : []
# }
# # Assuming 'tweets' is a dictionary where each value is an object with a 'clean_text' attribute
# for tweet in tweets.values():
#     if award_test_name in tweet.clean_text.lower():  # Using lower() for case-insensitive matching
#         test_list[award_test_name].append(tweet)

# empty=[]
# with open('tweet_award_names.txt', 'w', encoding='utf-8') as f:
#     for award, tweets in test_list.items():
#         if tweets:
...
# nominees=identify_nominees("best director", tweets)
# print(nominees)